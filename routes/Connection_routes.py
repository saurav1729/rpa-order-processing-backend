...
from controllers.Connection import add_Connection, delete_Connection, update_Connection ,get_Connections
...
Connection_bp.route('/Connections/<int:id>', methods=['PUT'])(company_or_admin_required(update_Connection))
